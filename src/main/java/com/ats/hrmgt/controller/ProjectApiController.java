...
public class ProjectApiController {
	...
	@RequestMapping(value = { "/getProjectAllList" }, method = RequestMethod.GET)
	public @ResponseBody List<ProjectHeader> getProjectAllList() {
	 
		List<ProjectHeader> list = new ArrayList<ProjectHeader>();
		try {

			list = projectHeaderRpo.findByDelStatusAndIsActive(1,1);
			System.out.println(list.toString());
